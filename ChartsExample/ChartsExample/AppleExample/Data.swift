...
struct TopStyleData {
    ...
    static let last30Days = [
        (name: "Cachapa", sales: 916, staff: 12),
        (name: "Injera", sales: 850, staff: 12),
        (name: "Crêpe", sales: 802, staff: 12),
        (name: "Jian Bing", sales: 753, staff: 12),
        (name: "Dosa", sales: 654, staff: 12),
        (name: "American", sales: 618, staff: 12)
    ]

    /// Sales by pancake style for the last 12 months, sorted by amount.
    static let last12Months = [
        (name: "Cachapa", sales: 9631, staff: 12),
        (name: "Crêpe", sales: 7959, staff: 12),
        (name: "Injera", sales: 7891, staff: 12),
        (name: "Jian Bing", sales: 7506, staff: 12),
        (name: "American", sales: 6777, staff: 12),
        (name: "Dosa", sales: 6325, staff: 12)
    ]
}
